...
/*
    ...
    */
    ...
    float max_speed_rps = 0.9f; // define maximum speed that the position controller is changig the speed, has to be smaller or equal to kn * max_voltage
    /*
        ...
        {  
            ...
            switch (robot_state_actual) {
                ...
                case release_bag:
                {
                        ...
                        max_speed_rps = 0.12f; // define maximum speed that the position controller is changig the speed, has to be smaller or equal to kn * max_voltage
                        positionController_M1.setMaxVelocityRPS(max_speed_rps); // adjust max velocity for internal speed controller
